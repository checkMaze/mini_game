...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Kampf-Logik
        int wins = simulateBattles(player, enemy, numberOfEnemies);
    ...
    private static int simulateBattles(Character player, Character enemy, int totalBattles) {
        int wins = 0;
    ...
    private static boolean conductBattle(Character player, Character enemy) {
    ...
    private static void performAttack(Character attacker, Character defender) {
    ...
    private static void displayResults(int wins, int totalBattles, int targetWinRate) {
        System.out.println("\n------ Results ------");
